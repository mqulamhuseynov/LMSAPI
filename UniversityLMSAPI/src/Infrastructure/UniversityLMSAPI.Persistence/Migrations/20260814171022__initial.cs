    ...
    public partial class _initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    GroupSubjectId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Assignments_GroupSubjects_GroupSubjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CourseMaterials_GroupSubjects_GroupSubjectId",
                        column: x => x.GroupSubjectId,
                        principalTable: "GroupSubjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Timetables_GroupSubjects_GroupSubjectId",
                        column: x => x.GroupSubjectId,
                        principalTable: "GroupSubjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GradedAt = table.Column<DateTime>(type: "timestamptz", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assignments_GroupSubjectId",
                table: "Assignments",
                column: "GroupSubjectId");

            migrationBuilder.CreateIndex(
                name: "IX_Attendances_StudentId_TimetableId",
                table: "Attendances",
                columns: new[] { "StudentId", "TimetableId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseMaterials_GroupSubjectId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupSubjects_GroupId_SubjectId_SemesterId",
                table: "GroupSubjects",
                columns: new[] { "GroupId", "SubjectId", "SemesterId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Timetables_ClassroomId_DayOfWeek_StartTime",
                table: "Timetables",
                columns: new[] { "ClassroomId", "DayOfWeek", "StartTime" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Timetables_GroupSubjectId",
                table: "Timetables",
                column: "GroupSubjectId");
        }
